...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Game.current_player'
        db.add_column(u'quizz_game', 'current_player',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['quizz.Player']),
                      keep_default=False)

        # Adding field 'Game.created_at'
        db.add_column(u'quizz_game', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 6, 15, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Game.current_player'
        db.delete_column(u'quizz_game', 'current_player_id')

        # Deleting field 'Game.created_at'
        db.delete_column(u'quizz_game', 'created_at')
