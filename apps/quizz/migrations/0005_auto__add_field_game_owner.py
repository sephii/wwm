...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'quizz_game', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='+', to=orm['quizz.Player']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Game.owner'
        db.delete_column(u'quizz_game', 'owner_id')
