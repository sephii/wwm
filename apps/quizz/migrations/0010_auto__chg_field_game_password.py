...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Game.password'
        db.alter_column(u'quizz_game', 'password', self.gf('django.db.models.fields.CharField')(default='', max_length=128))

    def backwards(self, orm):

        # Changing field 'Game.password'
        db.alter_column(u'quizz_game', 'password', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
